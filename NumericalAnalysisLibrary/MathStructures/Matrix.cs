    ...
    public class Matrix
    {
        ...
        public double Determinant
        {
            get
            {
                if (RowsCount != ColumnsCount)
                    throw new Exception(Constants.MatrixConstants.matrixWithoutDeterminantString);
        ...
        public static Matrix operator*(Matrix left, Matrix right)
        {
            if (left.ColumnsCount != right.RowsCount)
                throw new Exception(Constants.MatrixConstants.matriciesCannotBeMultipliedString);
        ...
        public static Matrix operator+(Matrix left, Matrix right)
        {
            if (left.RowsCount != right.RowsCount ||
                ...
                throw new Exception(Constants.MatrixConstants.matriciesCannotBeAddedString);
        ...
        public static Matrix operator-(Matrix left, Matrix right)
        {
            if (left.RowsCount != right.RowsCount ||
                left.ColumnsCount != right.ColumnsCount)
                throw new Exception(Constants.MatrixConstants.matriciesCannotBeSubstrainedString);
